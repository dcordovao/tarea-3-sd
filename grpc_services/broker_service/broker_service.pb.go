...
var file_broker_service_proto_rawDesc = []byte{
	...
	0x04, 0x62, 0x6f, 0x64, 0x79, 0x32, 0xd3, 0x01, 0x0a, 0x0d, 0x42, 0x72, 0x6f, 0x6b, 0x65, 0x72,
	0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x41, 0x0a, 0x0b, 0x45, 0x6e, 0x76, 0x69, 0x61,
	0x72, 0x56, 0x65, 0x72, 0x62, 0x6f, 0x12, 0x17, 0x2e, 0x62, 0x72, 0x6f, 0x6b, 0x65, 0x72, 0x5f,
	...
	,
...
var file_broker_service_proto_depIdxs = []int32{
	0, // 0: broker_service.BrokerService.EnviarVerbo:input_type -> broker_service.Message
	0, // 1: broker_service.BrokerService.SayHello:input_type -> broker_service.Message
	0, // 2: broker_service.BrokerService.EnviarDom:input_type -> broker_service.Message
	0, // 3: broker_service.BrokerService.EnviarVerbo:output_type -> broker_service.Message
	0, // 4: broker_service.BrokerService.SayHello:output_type -> broker_service.Message
	0, // 5: broker_service.BrokerService.EnviarDom:output_type -> broker_service.Message
...
type BrokerServiceClient interface {
	EnviarVerbo(ctx context.Context, in *Message, opts ...grpc.CallOption) (*Message, error)
	SayHello(ctx context.Context, in *Message, opts ...grpc.CallOption) (*Message, error)
	EnviarDom(ctx context.Context, in *Message, opts ...grpc.CallOption) (*Message, error)
}
...
func (c *brokerServiceClient) EnviarVerbo(ctx context.Context, in *Message, opts ...grpc.CallOption) (*Message, error) {
	out := new(Message)
...
func (c *brokerServiceClient) EnviarDom(ctx context.Context, in *Message, opts ...grpc.CallOption) (*Message, error) {
	out := new(Message)
	err := c.cc.Invoke(ctx, "/broker_service.BrokerService/EnviarDom", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type BrokerServiceServer interface {
	EnviarVerbo(context.Context, *Message) (*Message, error)
	SayHello(context.Context, *Message) (*Message, error)
	EnviarDom(context.Context, *Message) (*Message, error)
}
...
func (*UnimplementedBrokerServiceServer) EnviarVerbo(context.Context, *Message) (*Message, error) {
...
func (*UnimplementedBrokerServiceServer) EnviarDom(context.Context, *Message) (*Message, error) {
	return nil, status.Errorf(codes.Unimplemented, "method EnviarDom not implemented")
}
...
func _BrokerService_EnviarDom_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Message)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BrokerServiceServer).EnviarDom(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/broker_service.BrokerService/EnviarDom",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BrokerServiceServer).EnviarDom(ctx, req.(*Message))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _BrokerService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "EnviarDom",
			Handler:    _BrokerService_EnviarDom_Handler,
		},
	},
